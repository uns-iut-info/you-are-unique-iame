...
export default class FinalBoss extends Sphere {
    constructor(finalBossMesh, id, scaling, scene, texture){
        ...
        finalBossMesh.position.x = 0;
        //finalBossMesh.position.y = 5;     
        finalBossMesh.position.z = 0;
        finalBossMesh.speed = 4;
        finalBossMesh.frontVector = new BABYLON.Vector3(0, 0, 1);
        finalBossMesh.physicsImpostor = new BABYLON.PhysicsImpostor(finalBossMesh, BABYLON.PhysicsImpostor.SphereImpostor, { mass: 1,move:true,friction:0.8, restitution: 0.2 }, scene);
